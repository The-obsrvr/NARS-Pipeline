# Neuro-symbolic Argumentation Reasoning System 
...
Operationalize formal argumentation semantics over noisy real-world discourse for scalable macro-level persuasiveness detection.
...
Run the following command to build the Docker image, containing the 
...
**End to End Pipeline Shell file**
